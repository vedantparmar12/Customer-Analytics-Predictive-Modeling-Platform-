...
class RecommendationEngine:
    ...
    def run(self):
        ...
        # Save the sparse user-item matrix for later use
        joblib.dump(self.user_item_matrix, 
            os.path.join(self.output_path, "user_item_matrix.pkl")
        )
        ...
        return {
            ...
            'total_products': self.user_item_matrix.shape[1],
            'matrix_density': (self.user_item_matrix.nnz / (self.user_item_matrix.shape[0] * self.user_item_matrix.shape[1])) * 100,
            'models_built': ['item_similarity', 'user_similarity', 'svd'],
