    ...
    def get_models(self):
        ...
        models = {
            'Logistic_Regression_L2': LogisticRegression(
                penalty='l2',
                C=0.1,  # Moderate regularization (was 0.001)
                max_iter=5000,
                solver='liblinear',
            ...
            'Decision_Tree': DecisionTreeClassifier(
                max_depth=5,  # Moderate depth (was 3)
                min_samples_split=100,  # Reasonable split requirement (was 500)
                min_samples_leaf=50,  # Reasonable leaf size (was 200)
                max_features=0.7,  # Use 70% features (was 0.5)
                class_weight='balanced',
                random_state=42
            ),
            
            'Random_Forest': RandomForestClassifier(
                n_estimators=50,  # More trees (was 10)
                max_depth=5,  # Moderate depth (was 3)
                min_samples_split=100,  # Reasonable split (was 500)
                min_samples_leaf=50,  # Reasonable leaf (was 200)
                max_features=0.7,  # Use 70% features (was 0.3)
                max_samples=0.8,  # Use 80% samples per tree (was 0.5)
                class_weight='balanced',
                random_state=42,
                n_jobs=-1
            ),
            ...
            'Gradient_Boosting': GradientBoostingClassifier(
                n_estimators=100,  # More trees (was 30)
                max_depth=4,  # Moderate depth (was 2)
                learning_rate=0.1,  # Normal learning rate (was 0.01)
                subsample=0.8,  # More samples (was 0.5)
                max_features=0.7,  # More features (was 0.5)
                min_samples_split=100,  # Reasonable split (was 500)
                min_samples_leaf=50,  # Reasonable leaf (was 200)
            ...
            'XGBoost': xgb.XGBClassifier(
                ...
                learning_rate=0.1,  # Normal learning rate (was 0.01)
                subsample=0.8,  # More samples (was 0.5)
                colsample_bytree=0.8,  # More features (was 0.3)
                reg_alpha=1.0,  # Moderate L1 (was 10.0)
                reg_lambda=1.0,  # Moderate L2 (was 10.0)
                min_child_weight=10,  # Reasonable (was 50)
                gamma=0.1,  # Lower gamma (was 1.0)
            ...
            'SVM': SVC(
                C=1.0,  # Moderate regularization (was 0.01)
                kernel='rbf',
                gamma='scale',
                class_weight='balanced',
                probability=True,
